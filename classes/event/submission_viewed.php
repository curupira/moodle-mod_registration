...
/**
 * Registration viewed submission event
 *
...
class submission_viewed extends base {
	...
	public static function get_name() {
		return "Registration submission viewed";
	}
	...
	public function get_description() {
		...
		return "The user with id '$this->userid' viewed the submissions of the registration with id '" . $this->objectid . "'.";
	}
